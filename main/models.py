...
class CV(models.Model):
    ...
    education = models.TextField(verbose_name="Education", help_text="Your educational background")
    skills = models.ManyToManyField('Skill', blank=True, related_name='cv_skills', verbose_name="Skills")
